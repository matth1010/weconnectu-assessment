...
try {
    ...
    $entry = $id > 0 ? $repository->find($id) : null;
    ...
    $databaseError = 'This entry could not be loaded right now. Please try again shortly.';
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$notFound) {
    ...
    if ($postedId !== $id || $id <= 0) {
        $errors['form'] = 'This edit request is invalid. Please return to the dashboard and try again.';
    }
    ...
    if ($errors === []) {
        try {
            ...
            error_log($exception->getMessage());
            $databaseError = 'We could not update this entry right now. Please try again shortly.';
        }
    }
}
?>
...
<head>
    ...
    <title>Edit Entry | WeConnectU Assessment</title>
    ...
    <main class="clean-shell">
        ...
        <section class="clean-main">
            <header class="clean-header compact-header">
                <div>
                    <p class="eyebrow text-primary">Existing contact record</p>
                    <h1>Edit entry</h1>
                </div>
            </header>
            ...
            <section class="dashboard-panel clean-panel form-dashboard-panel" aria-labelledby="form-title">
                <div class="panel-heading">
                    <div>
                        <p class="eyebrow text-primary">Update form</p>
                ...
                <?php if ($notFound): ?>
                    <div class="empty-state">
                        ...
                        <p>The selected entry does not exist or may have been removed.</p>
                ...
                <?php else: ?>
                    ...
                    <form method="post" action="edit.php?id=<?= e((string) $id) ?>" id="contact-form" novalidate>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= e($values['name']) ?>" maxlength="120" aria-describedby="name-help name-error" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control <?= isset($errors['email']) ? 'is-invalid' : '' ?>" id="email" name="email" value="<?= e($values['email']) ?>" maxlength="190" aria-describedby="email-help email-error" required>
                            ...
                            <div class="col-12">
                                ...
                                <input type="tel" class="form-control <?= isset($errors['phone']) ? 'is-invalid' : '' ?>" id="phone" name="phone" value="<?= e($values['phone']) ?>" placeholder="021 123 4567" aria-describedby="phone-help phone-error" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control <?= isset($errors['message']) ? 'is-invalid' : '' ?>" id="message" name="message" rows="6" maxlength="2000" aria-describedby="message-help message-error" required><?= e($values['message']) ?></textarea>
